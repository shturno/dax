                ...
                <dl className="grid grid-cols-1 gap-y-4">
                  <div>
                    ...
                    <dd className="mt-1 flex items-center">
                      <span
                        className={`inline-block h-4 w-4 rounded-full ${profileData.settings?.notifications ? 'bg-green-400' : 'bg-gray-600'}`}
                      ></span>
                  ...
                  <div>
                    ...
                    <dd className="mt-1 flex items-center">
                      <span
                        className={`inline-block h-4 w-4 rounded-full ${profileData.settings?.autoSave ? 'bg-green-400' : 'bg-gray-600'}`}
                      ></span>
                      <span className="ml-2 text-sm">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm flex items-center">
                      <span
                        ...
                        style={{
                          backgroundColor:
                            profileData.settings?.primaryColor === 'red'
                              ? '#ef4444'
                              : profileData.settings?.primaryColor === 'green'
                                ? '#10b981'
                                : profileData.settings?.primaryColor === 'purple'
                                  ? '#8b5cf6'
                                  : profileData.settings?.primaryColor === 'amber'
                                    ? '#f59e0b'
                                    : '#3b82f6',
                        }}
                      ></span>
                      {profileData.settings?.primaryColor === 'default'
                        ...
                        : profileData.settings?.primaryColor
                          ? profileData.settings.primaryColor.charAt(0).toUpperCase() +
                            profileData.settings.primaryColor.slice(1)
                          : 'Padrão (Azul)'}
                    </dd>
                  </div>
                </dl>
              ...
              <CardContent>
                <div className="mb-6">
                  <h4 className="text-base font-medium">
                    {profileData.settings?.projectName || 'Meu Projeto'}
                  </h4>
